...
import { ArrowLeft, RotateCcw, Lightbulb, Microscope, Atom } from "lucide-react"
...
const experiments: Experiment[] = [
  {
    ...
    materials: ["Clear glass of water", "White paper", "Sunlight or flashlight"],
    steps: [
  ...
  },
  {
    ...
    materials: ["Baking soda", "Vinegar", "Food coloring", "Dish soap", "Small bottle"],
    steps: [
  ...
  },
  {
    ...
    materials: ["Lemon juice", "Cotton swab", "White paper", "Heat source (adult help needed)"],
    steps: [
...
export default function ScienceGame() {
  ...
  const handleStepComplete = (stepIndex: number) => {
    ...
    if (selectedExperiment && completedSteps.size + 1 === selectedExperiment.steps.length) {
  ...
  const isExperimentCompleted = selectedExperiment ? completedExperiments.has(selectedExperiment.id) : false
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-100 via-cyan-50 to-blue-100">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Discover amazing science with fun experiments!</p>
        </div>
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    {completedExperiments.has(experiment.id) && <div className="ml-auto text-green-500">✅</div>}
                  </div>
                  <p className="text-gray-600 mb-4">{experiment.description}</p>
                  <div className="text-center">
                    <span className="kid-button inline-block">Start Experiment</span>
                  </div>
                </CardContent>
              </Card>
            ))}
            ...
            <Card className="bg-white shadow-2xl mb-6">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-gray-800 mb-2">{selectedExperiment.title}</h2>
                  <span className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm font-bold">
                    {selectedExperiment.category}
                  </span>
                  <p className="text-gray-600 mt-4">{selectedExperiment.description}</p>
                </div>
                ...
                <div className="flex justify-between">
                  <Button onClick={handlePrevStep} disabled={currentStep === 0} variant="outline" className="px-6 py-3">
                    Previous Step
                  </Button>

                  <Button onClick={() => setSelectedExperiment(null)} variant="outline" className="px-6 py-3">
                    Back to Experiments
                  </Button>
                ...
                {isExperimentCompleted && (
                  <div className="text-center mt-8">
                    <div className="bg-green-100 rounded-xl p-6">
                      <h3 className="text-2xl font-bold text-green-600 mb-2">🧪 Experiment Complete! 🧪</h3>
                      <p className="text-green-700">
                        Great job scientist! You've completed the experiment and learned something new!
                      </p>
                    </div>
                  </div>
                )}
