...
export default function QuizzesGame() {
  ...
  const isQuizCompleted = currentQuestionIndex === quizQuestions.length - 1 && showResult
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-indigo-50 to-blue-100">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Test your knowledge with fun questions!</p>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <Card className="bg-white shadow-2xl mb-6">
              <CardContent className="p-8">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8">{currentQuestion.question}</h2>
                ...
                {showHint && (
                  <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-6 rounded">
                    <div className="flex items-center">
                      ...
                      <span className="text-yellow-800 font-bold">Hint: {currentQuestion.hint}</span>
                    </div>
                  </div>
                )}
                ...
                <div className="flex justify-center space-x-4">
                  {!showResult ? (
                    <>
                      ...
                      <Button onClick={handleSubmit} disabled={selectedAnswer === null} className="kid-button">
                        Submit Answer
                      </Button>
                    </>
                  ) : (
                    <Button onClick={handleNext} className="kid-button">
                      {currentQuestionIndex < quizQuestions.length - 1 ? t("next") : "Finish Quiz"}
                    </Button>
                  )}
                </div>
                  ...
                  <div className="mt-6 text-center">
                    ...
                    >
                      {selectedAnswer === currentQuestion.correctAnswer
                        ...
                        : `❌ ${t("tryAgain")}! The correct answer was: ${currentQuestion.options[currentQuestion.correctAnswer]}`}
                    </div>
                  </div>
                )}
              </CardContent>
            ...
            <div className="bg-white rounded-full p-2 shadow-lg">
              ...
              <p className="text-center mt-2 font-bold text-gray-700">
                Progress: {currentQuestionIndex + (showResult ? 1 : 0)}/{quizQuestions.length}
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="text-center">
            <Card className="bg-white shadow-2xl max-w-2xl mx-auto">
              <CardContent className="p-8">
                ...
                <p className="text-2xl text-gray-700 mb-6">Final Score: {score} points</p>
                <p className="text-lg text-gray-600 mb-8">You answered {answeredQuestions.size} questions correctly!</p>
