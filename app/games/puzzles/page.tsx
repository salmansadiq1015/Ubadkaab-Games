...
const puzzleImages = [
  ...
  },
  {
    ...
    name: "Fruits",
    pieces: ["🍎", "🍌", "🍇", "🍊", "🍓", "🥝"],
    description: "Match the colorful fruits!",
  },
  {
    id: 4,
    name: "Shapes",
    pieces: ["⭐", "❤️", "🔺", "🟦", "⚪", "💎"],
    description: "Sort the shapes correctly!",
  },
];
...
export default function PuzzlesGame() {
  ...
  const handleSlotClick = (targetPosition: number) => {
    ...
    const targetPiece = puzzlePieces.find(
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Solve puzzles by arranging pieces in the correct order!
          </p>
        </div>
              ...
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">
                    {selectedPuzzle.name} Puzzle
                  </h2>
                  <p className="text-gray-600">{selectedPuzzle.description}</p>
                  <p className="text-sm text-gray-500 mt-2">
                    👆 Tap a piece to select it, then tap where you want to move
                    it!
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 md:grid-cols-6 gap-4 mb-6 max-w-2xl mx-auto">
                  {Array.from(
                    { length: selectedPuzzle.pieces.length },
                    (_, index) => {
                  ...
                  <div className="text-center mt-6">
                    <div className="bg-green-100 rounded-xl p-6">
                      ...
                      <p className="text-green-700">
                        Completed in {moves} moves! Bonus score:{" "}
                        {Math.max(100 - moves * 5, 20)} points
                      </p>
                    </div>
                  </div>
                )}
